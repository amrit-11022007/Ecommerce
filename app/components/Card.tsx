  ...
  return (
    <Link href={`/products/${product.id}`} className="block">
      <article className="group relative flex flex-col gap-4 rounded-3xl bg-white border border-gray-100 p-4 transition-all duration-500 hover:shadow-xl hover:shadow-[#6C63FF]/10 hover:-translate-y-2 hover:border-[#6C63FF]/20">
        ...
        <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-[#F0F8FF] to-[#F8F9FA] p-6 pointer-events-none">
        ...
        <div className="flex items-start justify-between gap-3 pointer-events-none">
          ...
          <div className="flex shrink-0 items-center gap-1.5 rounded-full bg-gradient-to-r from-[#FF9F43]/10 to-[#FF9F43]/5 px-3 py-1.5 pointer-events-auto">
        ...
        <div className="flex items-end justify-between mt-auto pointer-events-none">
          ...
          <span
            ...
            className="pointer-events-auto inline-flex items-center justify-center rounded-full w-11 h-11 bg-gradient-to-r from-[#2874F0] to-[#6C63FF] text-white shadow-lg shadow-[#6C63FF]/20 hover:shadow-xl hover:shadow-[#6C63FF]/30 hover:scale-110 transition-all duration-300"
          >
            <Plus size={18} />
          </span>
        </div>
